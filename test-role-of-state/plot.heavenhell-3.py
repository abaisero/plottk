...
datadir = 'data/heavenhell-3'

flags = load_toml('flags.toml') | {
    'normalize': False,
    'interquantile': False,
}
dataconfig = load_toml('dataconfig.heavenhell-3.toml')
...
limits = load_toml('plotconfig.xlimit.heavenhell-3.toml')
